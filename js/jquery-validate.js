(function(factory) {
    ...
    var RULES = {
        ...
        isNum_En: function(value, errorMsg) {
            //字母或者数字 
        ...
        onlyZhEn: function(value, errorMsg) {
            //中英文
        	  if (!/^[\u4e00-\u9fa5A-Z\-\a-z]+$/.test(value)) {
                return errorMsg;
            }
        },
        ...
        onlysydjh: function(value, errorMsg) {//
            //税务登记号  包含x
            if (!/^[0-9|x|X]+([.][0-9]+){0,1}$/.test(value)) {
                return errorMsg;
            }
        },
